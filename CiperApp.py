...
st.write("Encrypt your text using the Caesar cipher. Begin by entering your preferred choice of text. Then, proceed to click the Encode button, and it runs before your eyes! If you wish to return back to the original text, enter the decrypted text to the text book. Click Decode to unmask the hidden text!")
